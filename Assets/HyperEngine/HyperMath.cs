...
public struct GyroVectorD {
    ...
    public void AlignUpVector() {
        //TODO: I'm sure all this math could simplify eventually...
        Vector3D desiredUp = HM.UpVector(vec);
        Vector3D currentUp = QuaternionD.Inverse(gyr) * Vector3D.up;
        QuaternionD correction = QuaternionD.FromToRotation(desiredUp, currentUp);
        gyr = gyr * correction;
    }
